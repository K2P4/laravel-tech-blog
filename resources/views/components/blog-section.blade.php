...
<div class="text-center mx-auto">
    ...
    <div class="card-body">
        ...
        <div class="flex items-center gap-3  justify-center my-3 text-capitalize">
            <button type="button" class=" bg-blue-500 rounded-md active:scale-95 text-white font-medium px-4 py-2   hover:bg-blue-400 transition-all duration-500 "><a class=" text-decoration-none " href="/?category={{$blog->category->slug}}">{{$blog->category->name}}</a></button>
